...
import { ICodeMapperCodeBlock, ICodeMapperRequest, ICodeMapperResponse, IAideAgentCodeMapperService } from '../../common/aideAgentCodeMapperService.js';
...
function notifyUserAction(chatService: IAideAgentService, context: ICodeBlockActionContext, action: ChatUserAction) {
	if (isResponseVM(context.element)) {
		chatService.notifyUserAction({
			...
			// TODO(@ghostwriternr): This is obviously wrong, but not urgent to fix.
			requestId: context.element.sessionId,
